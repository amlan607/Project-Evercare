 ...
 * @author ASUS
 */
public final class Opsonin extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Opsonin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
