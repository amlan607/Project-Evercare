 ...
 * @author ASUS
 */
public final class ShowElectronics extends javax.swing.JFrame {

    /**
     * Creates new form ShowElectronics
     */
    ...
    void table_loaded() {
        try {
            ...
            st = con.prepareStatement("select * from electronics");
            rs = st.executeQuery();
            ResultSetMetaData rsmd = rs.getMetaData();
            DefaultTableModel model = (DefaultTableModel) electronics.getModel();
    ...
    private void initComponents() {
        ...
        electronics = new javax.swing.JTable();
        ...
        jLabel2.setText("OPSONIN Products");

        jScrollPane1.setViewportView(electronics);
    ...
    private void orderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_orderActionPerformed
        try {
            ...
            String sql = "select * from electronics where pid=?";
            Connect cn = new Connect();
            con = cn.getConnection();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowElectronics.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowElectronics().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable electronics;
